// BJS reference for Scene 69 — mirrors the Lite scene exactly. Same NME JSON,
// same 4-light + env setup, plus a hot magenta SheenBlock connected to PBR-MR.sheen.
...
(async function () {
    ...
    const nm = NodeMaterial.Parse(SCENE69_NME_JSON, scene);
    nm.build(false);
    sphere.material = nm;
